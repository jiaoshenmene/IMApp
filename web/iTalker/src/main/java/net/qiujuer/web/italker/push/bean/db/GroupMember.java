...
public class GroupMember {
    ...
    public static final int PERMISSION_LEVEL_NONE = 0; //默认权限，普通成员

    public static final int PERMISSION_LEVEL_ADMIN = 1; //默认通知级别

    public static final int PERMISSION_LEVEL_ADMIN_SU = 100; //创建者
